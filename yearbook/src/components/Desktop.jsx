				...
				<div className="recognition-slide" ref={nextBlockRef}>
						<div className='title-intro'>
							...
							<div className='recognition-menu'>
								{/* <p ref={cartRef} className="rec-item rec-active" onClick={toCarting}>FIA Carting Champions</p>
								<p ref={munRef} className="rec-item" onClick={toMun}>Model United Nations</p>
								<p ref={athRef} className="rec-item" onClick={toAthletics}>Athletics</p> */}
							</div>
						</div>
